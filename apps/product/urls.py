...
from .views import ProductDetailView, ListProductsView, ListSearchView, ListRelatedView, ListBySearchView, UploadPDFView
...
urlpatterns = [
    ...
    path('download-pdf/<int:pk>/', UploadPDFView.as_view()),
    ] 